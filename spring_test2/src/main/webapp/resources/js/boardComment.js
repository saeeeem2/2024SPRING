...
function spreadCommentList(bno, page=1){
    getCommentListFromServer(bno,page).then(result=>{
        ...
        if(result.cmtList.length > 0){
            ...
            //댓글을 다시 뿌릴때는 기존 값을 삭제하면 안 되고 1page일 경우만 삭제
            if(page==1){
                ul.innerHTML='';
            } 
            for(let cvo of result.cmtList){
                ...
                li+=`<button type="button" class="btn btn-success btn-sm mod me-1 ms-1" data-bs-toggle="modal" data-bs-target="#myModal">수정</button>`
